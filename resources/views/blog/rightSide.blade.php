	...
	<div class="col s12 m12">
		<div class="category-container">
			...
			<div class="collection collection-fix">
				...
				<a href="#!" class="collection-item border-right-green grey-text">{{$categories[3]->name}}</a>
				<a href="#!" class="collection-item border-right-purple grey-text">{{$categories[4]->name}}</a>
			</div>
		</div>
	</div>
</div>
